...
function Howitworks() {
   return (
      <div class="works-page">
         <div class="custom-shape-divider-bottom-1613041978">
            <svg
               data-name="Layer 1"
               ...
               <div class="howitworks-box col-md-5 col-lg-3 col-sm-8 col-8 d-flex flex-column align-items-center mt-3">
                  ...
                  <div class="works-text-box">
                     ...
                     <div class="works-text-description">
                        Enter team names, select players and tune other parameters as you like. Don't forget to adjust
                        the placements of the players!
                     </div>
                  </div>
               </div>
